...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let navContoller = UINavigationController(rootViewController: mainVC)
    ...
    private func setGriffonConfiguration(){
        ...
        clientSecret: "EWBh1XuiJjSCu9uG0Jmq4xGkOdLKFKg5nURpDq0IBKmqHcP3WsyaSjRXa-dOfLoy",
        url: "https://griffon.dar-dev.zone/api/v1")
